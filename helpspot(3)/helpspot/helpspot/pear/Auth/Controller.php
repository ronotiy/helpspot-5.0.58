...
class Auth_Controller
{
     ...
     */
    public function __construct($auth_obj, $login = 'login.php', $default = 'index.php', $accessList = [])
    {
        $this->auth = $auth_obj;
     ...
     * @return void
     */
    public function setAutoRedirectBack($flag = true)
    {
    ...
    public function redirectBack()
    {
        ...
        echo "You could not be redirected to <a href=\"$returnUrl\">$returnUrl</a>";
    }
    ...
    public function redirectLogin()
    {
        ...
        header('Location:'.$url);
        echo "You could not be redirected to <a href=\"$url\">$url</a>";
    }
