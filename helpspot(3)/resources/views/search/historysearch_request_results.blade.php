    ...
    <tbody>
        ...
        <tr class="tablerowoff">
            <td class="tcell" width="80">
                <a href="admin?pg=request.static&reqid={{{ $result['id'] }}}" onclick="showRequestDetails({{{ $result['id'] }}}); return false">&nbsp;<a href="admin?pg=request&amp;reqid={{{ $result['id'] }}}" target="_blank"><img border="0" src="{{ static_url() }}/static/img5/external.svg" style="margin-bottom:-2px;margin-left: 2px;height: 14px;"></a>
            </td>
